#!/usr/bin/env python3
"""Build EXP-007 Stock Hybrid Control without loading a language model.

The control is an APFS clone of frozen EXP-005. Only all full-attention Q/K/V/O
...
CONTROL = OUT / 'stock-hybrid-control/qwen36-stock-hybrid-control.gturbo'
SOURCE = ROOT / 'results/raw/EXP-005/model/qwen36.gturbo'
...
def main() -> int:
    ...
    generated_dir = OUT / 'stock-hybrid-control/generated-resident'
    ...
    manifest['modelID'] = 'exp007-stock-hybrid-control-qwen36-35b-a3b-4bit'
    ...
    result = {
        'experiment': 'EXP-007', 'artifact': 'Stock Hybrid Control',
